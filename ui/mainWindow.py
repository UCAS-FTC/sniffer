...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.splitter_2.setGeometry(QtCore.QRect(10, 250, 1111, 551))
        ...
        self.label.setGeometry(QtCore.QRect(20, 104, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(parent=Form)
        self.lineEdit.setGeometry(QtCore.QRect(100, 100, 361, 30))
        self.lineEdit.setClearButtonEnabled(True)
        self.lineEdit.setPlaceholderText("Only")
